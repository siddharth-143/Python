...
def show_user_data(request):
    ...
    data2 = User.objects.filter(email='ventya@gmail.com')
    # data3 = User.objects.filter(page__page_cat='Programming')           
    data3 = User.objects.filter(mypage__page_cat='Programming')             # alternative way to write (page__)
    data4 = User.objects.filter(post__post_publish_date='2021-12-01')
...
def show_page_data(request):
    ...
    data3 = Page.objects.filter(user__email='ventya@gmail.com')
...
def show_post_data(request):
    ...
    data2 = Post.objects.filter(post_publish_date='2021-12-01')
    data3 = Post.objects.filter(user__username='ventya')
...
def show_song_data(request):
    ...
    data3 = Song.objects.filter(user__username='ventya')
