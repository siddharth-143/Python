...
def light_theme():
    ...
    lbl_1 = tk.Label(frame, font=('calibre', 40, 'bold'), background='White', foreground='black')
    lbl_1.pack(anchor="s")
...
def dark_theme():
    ...
    frame.place(relx=0.1, rely=0.1, relwidth=0.8, relheight=0.8)
    lbl_2 = tk.Label(frame, font=('calibre', 40, 'bold'), background='#22478a', foreground='black')
    lbl_2.pack(anchor="s")
